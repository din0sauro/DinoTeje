...
SECRET_KEY = 'django-insecure-kgn9#20c3gi^&8e%qfyn(p1@+nw+c9b96rdtz=5vnr-g5h^gv8'
...
ROOT_URLCONF = 'dinotejeproject.urls'
...
WSGI_APPLICATION = 'dinotejeproject.wsgi.application'

# settings.py
AUTH_USER_MODEL = 'auth.User'  # Solo si estás usando el modelo de usuario por defecto de Django.
